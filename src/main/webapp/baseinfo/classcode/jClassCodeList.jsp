			...
			<div id="middleMenubar">
				<div id="innerMenubar">
					<div id="navMenubar">
						<ul>
							<li id="new"><a href="#"
								onclick="formSubmit('/baseinfo/classCodeAction_tocreate','_self');this.blur();">新建</a></li>
							<li id="update"><a href="#"
								onclick="formSubmit('/baseinfo/classCodeAction_toupdate','_self');this.blur();">修改</a></li>
							<li id="delete"><a href="#"
								onclick="formSubmit('/baseinfo/classCodeAction_delete','_self');this.blur();">删除</a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="textbox" id="centerTextbox">
			<div class="textbox-header">
				<div class="textbox-inner-header">
					<div class="textbox-title">代码分类列表</div>
				</div>
			</div>
		</div>
			...
			<div id="find_div" style="width: 98%;">
				<fieldset>
					...
					<div style="width: 98%; padding-top: 7px; text-align: left;">
						...
						<input id="btnFind" type="button" name="btnFind" value="查询"
							onclick="formSubmit('/baseinfo/classCodeAction_list','_self');this.blur();">
						<input type="button" name="btnReset" value="清空"
